@extends('layouts.main', ['activePage' => 'supervisor', 'titlePage' => 'Supervisor Personal-Usuarios'])
@section('content')
<div class="content">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-end">
                                        ...
                                        <a href="{{ route('superpersonal.create') }}"
                                            class="btn btn-sm btn-facebook">Añadir
                                            personal</a>
